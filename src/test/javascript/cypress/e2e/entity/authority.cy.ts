...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0facac4e-6deb-4150-a354-10d766b64d19' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ab3b219e-6cb0-44e3-9429-e904026a6049');
      cy.get(`[data-cy="name"]`).should('have.value', 'ab3b219e-6cb0-44e3-9429-e904026a6049');
